module model
    ...
    ! Model
    !
    ! model(1) Number of vectors in get_model - NV
    ! model(2) Number of Loops - NL
    ...
    ! 10 CONTINUE
    !
    !  Each vector has a length and an angle, therefore 2 * NV is the Total
    !  number of elements used to describe the starting mechanism position
    !
    !  I=6+2*NV
    !  NF=I+2*NL-1
    !  DO 20 N=I,NF
